...
HierAverageFragFitness::HierAverageFragFitness() : FitnessFunction() {}

PropertiesList * HierAverageFragFitness::checkFitness(GenePool ** pools, int * indexes, int genomeLength) {
...
string HierAverageFragToString::toString(GenePool ** pools, int * indexes, int genomeLength) {
	string returnString = "";
	stringstream ss;
	int * tempIntPtr;
	Individual * tempIndividual;	
